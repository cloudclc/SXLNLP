...
class SiameseNetwork(nn.Module):
    ...
    def cosine_distance(self, tensor1, tensor2, tensor3):
        tensor1 = torch.nn.functional.normalize(tensor1, dim=-1)
        tensor2 = torch.nn.functional.normalize(tensor2, dim=-1)
        tensor3 = torch.nn.functional.normalize(tensor3, dim=-1)
        cosine = torch.sum(torch.mul(tensor1, tensor2, tensor3), axis=-1)
        return 1 - cosine
